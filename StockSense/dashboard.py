...
class IMS:
    def __init__(self,root):
        ...
        self.root.title("StockSense")

        #===Title===
        self.icon_title=PhotoImage(file="images/logo1.png")
        title=Label(self.root,text="StockSense",image=self.icon_title,compound=LEFT,font=("times new roman",40,"bold"),bg="#010c48",fg="white",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)
        ...
        #==clock==
        self.lbl_clock=Label(self.root,text="Welcome to StockSense\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS",font=("times new roman",15,),bg="#4d636d",fg="white")
...
#============================================================================
    ...
    def update_content(self):
        ...
        try:
            ...
            self.lbl_clock.config(text=f"Welcome to StockSense\t\t Date: {str(date_)}\t\t Time: {str(time_)}")
